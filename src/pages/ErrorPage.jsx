  ...
  return (
    <div className="min-h-screen bg-[#1F5B4B] flex items-center justify-center px-6">
      <div className="text-center max-w-2xl">
        {/* 404 Number */}
        <h1 className="text-[140px] md:text-[220px] font-bold text-white/15 leading-none">
          404
        </h1>

        {/* Glass Card */}
        <div className="-mt-10 rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-10 shadow-2xl">
